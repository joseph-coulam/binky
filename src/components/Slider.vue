  ...
  <div class="aliased slider w-100 my-14 rounded-xl">
    <vue-glide type="slider" :perView="1" :gap="0">
      ...
      <template class="test" slot="control">
        <button
          class="hidden md:block absolute top-0 bottom-0 left-4 xl:-left-12 my-auto"
          data-glide-dir="<"
        >
          <img
            src="@/assets/images/control-left.png"
            width="22"
            height="40"
            alt="Left"
          />
        ...
        <button
          class="hidden md:block absolute top-0 bottom-0 right-4 xl:-right-12 my-auto"
          data-glide-dir=">"
        >
          <img
            src="@/assets/images/control-right.png"
            width="22"
            height="40"
            alt="Right"
          />
